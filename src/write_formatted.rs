...
#[rustfmt::skip] impl<W: io::Write + ?Sized> WriteFormatted for Box<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl<W: io::Write> WriteFormatted for io::BufWriter<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for process::ChildStdin { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for io::Cursor<Box<[u8]>> { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for io::Cursor<Vec<u8>> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for io::Cursor<&'a mut [u8]> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for io::Cursor<&'a mut Vec<u8>> { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for fs::File { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for fmt::Formatter<'a> { impl_for_fmt_write!(); }
#[rustfmt::skip] impl<W: io::Write> WriteFormatted for io::LineWriter<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for io::Sink { impl_for_io_write!(); }
#[rustfmt::skip] impl WriteFormatted for io::Stderr { impl_for_io_write!(); }
...
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut [u8] { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a, W: io::Write + ?Sized> WriteFormatted for &'a mut Box<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a, W: io::Write> WriteFormatted for &'a mut io::BufWriter<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut process::ChildStdin { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut io::Cursor<Box<[u8]>> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut io::Cursor<Vec<u8>> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a, 'b> WriteFormatted for &'a mut io::Cursor<&'b mut [u8]> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a, 'b> WriteFormatted for &'a mut io::Cursor<&'b mut Vec<u8>> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut fs::File { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a, 'b> WriteFormatted for &'a mut fmt::Formatter<'b> { impl_for_fmt_write!(); }
#[rustfmt::skip] impl<'a, W: io::Write> WriteFormatted for &'a mut io::LineWriter<W> { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut io::Sink { impl_for_io_write!(); }
#[rustfmt::skip] impl<'a> WriteFormatted for &'a mut io::Stderr { impl_for_io_write!(); }
